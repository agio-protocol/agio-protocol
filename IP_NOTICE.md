...
All other source code, including but not limited to the off-chain settlement
service, platform application code, SDK, deployment scripts, documentation,
and configuration files, is proprietary and confidential. Unauthorized copying,
distribution, modification, or use of this code is strictly prohibited.
...
For licensing inquiries: github.com/agio-protocol
